...
public class DeleteFile implements FileStorageSubFunction {
  ...
  public FileStorageOutput executeSubFunction(FileStorageInput input,
    ...
    try {
      ...
      traceExecution.append("StorageDefinition[");
      traceExecution.append(fileVariableReference.getStorageDefinition());
      traceExecution.append("] ");

      boolean filePurged = fileRepoFactory.purgeFileVariable(fileVariableReference);
      traceExecution.append("Purged[");
      traceExecution.append(filePurged);
      traceExecution.append("]");
