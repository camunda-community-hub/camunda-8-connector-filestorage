...
public class FileStorageOutput implements CherryOutput {
    ...
    public static final String OUTPUT_FILE_NAME_LOADED = "fileNameLoaded";
    ...
    public static final String OUTPUT_LIST_FILE_LOADED = "listFilesLoaded";
    ...
    public List<String> listFilesLoaded = new ArrayList<>();
