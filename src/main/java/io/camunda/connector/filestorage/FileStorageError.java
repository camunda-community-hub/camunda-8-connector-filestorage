...
public class FileStorageError {
    ...
    public static final String BPMNERROR_COPY_FILE_ERROR = "COPY_FILE_ERROR";
    public static final String BPMNERROR_COPY_FILE_ERROR_EXPL = "Error when the file is copied to the storage";
